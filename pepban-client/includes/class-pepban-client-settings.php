...
class PepBan_Client_Settings {
	...
	public static function init() {
		...
		add_action( 'admin_post_pepban_client_send_test_email',  array( __CLASS__, 'send_test_email' ) );
		add_action( 'admin_notices', array( __CLASS__, 'admin_notices' ) );
	}

	public static function send_test_email() {
		if ( ! current_user_can( 'manage_woocommerce' ) ) wp_die( 'Unauthorized' );
		check_admin_referer( 'pepban_send_test_email' );
	...
	public static function register_menu() {
		...
		add_submenu_page( 'pepban-client', 'Customer Lookup',    'Customer Lookup',    'manage_woocommerce', 'pepban-client-lookup',    array( 'PepBan_Client_Lookup',    'render_page' ) );
